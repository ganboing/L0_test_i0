...
// 10 points k=2
#define TINY_EXP
// For correctness check. Final centroids should be:
// 2 Centroids:
// 144356893 44718345 -1586547709 798468608
// -140711182 917662924 -464815512 233054119
// #define TINY_EXP
// #define SMALL_EXP
// 204.8M points k=1000
// #define LARGE_EXP
...
// get input from persistent memory
// #define INPUT_PMEM
// output to persistent memory
// #define OUTPUT_PMEM
...
// #define PMEM_IN_ADDR  (0xC0000000000)
// #define PMEM_OUT_ADDR (0xE0000000000)
...
void on_recluster_finished_0()
{
    ...
    *((long *)STDOUT) = 'E';
    ...
    for(i = 0; i < N/PSIZE; i = i + N_LONG_PAGE)
    {
        if(trigger[i] != 2)
        {
            abort;
